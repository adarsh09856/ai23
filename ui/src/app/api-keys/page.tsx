...
export default function APIKeysPage() {
    ...
    const handleCreateKey = async () => {
        if (!newKeyName.trim()) { setError('Please enter a name for the API key'); return; }
        try {
            setError(null);
            const accessToken = await getAccessToken();
    ...
    const handleArchiveKey = async (keyId: number) => {
        try {
            ...
            logger.error('Error archiving API key:', err);
        }
    };
    ...
    const handleReactivateKey = async (keyId: number) => {
        try {
            ...
            logger.error('Error reactivating API key:', err);
        }
    };
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="mb-8">
                        ...
                        <p className="text-muted-foreground">
                            Manage API keys to access platform services programmatically
                        </p>
                    </div>
                                        ...
                                        >
                                            <div className="flex-1">
                                                ...
                                                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                                    ...
                                                    <span className="text-xs text-muted-foreground/70">(Full key hidden for security)</span>
                                                </div>
                                                <div className="mt-2 text-xs text-muted-foreground">
                                                    Created: {formatDate(key.created_at)} &bull;
